...
// "use strict" en JavaScript proporciona un entorno más seguro y con reglas más 
// estrictas que ayudan a prevenir errores y promover buenas prácticas de programación. 
// Se recomienda utilizarlo en todos los nuevos proyectos y al modificar código existente 
// para garantizar un código más robusto y confiable. 

/* -->> 1 Tipos de Datos <<-- */
// String, Cadena de Texto, literal de texto.

// los strings se pueden crear utilizando comillas simples (''), comillas dobles ("") o comillas invertidas (``).
// un string en JavaScript es un tipo de dato utilizado para almacenar y manipular texto.
...
//  "let" en JavaScript se utiliza para declarar variables locales dentro de un bloque de código.
//  "let" se utiliza para declarar variables locales en JavaScript y proporciona un alcance de bloque más seguro y predecible.

// La etiqueta "console.log()" en JavaScript se utiliza para imprimir mensajes o valores en la consola 
// del navegador o en la consola de desarrollo de JavaScript.
...
var c4 = "Mundo";
console.log(c3 + c4);
console.log(c3 + c4 + 1); // Concatenación cuando se trata de un string y un número.
// var es la forma antigua de declarar variables y let es la forma nueva de declarar variables.

/* -->> 2 Enteros <<-- */
// un entero en JavaScript es un tipo de dato que representa un número entero sin decimales. 
//Se utilizan para realizar operaciones matemáticas, comparaciones y almacenar valores numéricos completos en variables.v
let numeroUno = 10;
let numeroDos = 2;
let numeroTres = 3.5;
...
// un booleano es un tipo de dato que solo puede tener dos valores: verdadero (true) o falso (false). 
// Los booleanos se utilizan para representar el estado de una condición o para realizar operaciones lógicas.
...
// el operador  typeof  en JavaScript se utiliza para determinar el tipo de dato de una variable o expresión.
// ejemplo
